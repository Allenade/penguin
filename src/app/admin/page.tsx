        ...
        >
          <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 px-6">
              <a
                href="#"
                className="flex items-center px-3 py-2 text-sm font-medium text-blue-600 bg-blue-50 dark:bg-blue-900/20 dark:text-blue-400 rounded-md"
              >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Overview of wallet submissions and activity
              </p>
            </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-4 lg:p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <div className="flex items-center">
                  <div className="p-2 bg-purple-100 dark:bg-purple-900/20 rounded-lg">
                    <BarChart3 className="h-5 w-5 lg:h-6 lg:w-6 text-purple-600 dark:text-purple-400" />
                  </div>
                  <div className="ml-3 lg:ml-4">
                    <p className="text-xs lg:text-sm font-medium text-gray-600 dark:text-gray-400">
                      This Week
                    </p>
                    <p className="text-xl lg:text-2xl font-bold text-purple-600 dark:text-purple-400">
                      0
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-400 dark:text-gray-500 text-xs mt-1">
                  Wallet submissions will appear here
                </p>
              </div>
            </div>
          </div>
