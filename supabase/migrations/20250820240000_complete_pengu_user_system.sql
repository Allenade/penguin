-- Complete PENGU User Authentication System Migration
-- This migration adds all the necessary tables for the PENGU user system

-- Drop existing auth_profiles table if it exists (we'll replace it with user_profiles)
DROP TABLE IF EXISTS auth_profiles CASCADE;

-- Create user_profiles table (replaces auth_profiles)
